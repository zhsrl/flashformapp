...
class PreviewViewMobile extends ConsumerStatefulWidget {
  const PreviewViewMobile({
    super.key,
  ...
  @override
  ConsumerState<PreviewViewMobile> createState() => _PreviewViewState();
}

class _PreviewViewState extends ConsumerState<PreviewViewMobile>
  ...
  Widget _buildDeviceFrame(
    ...
    return AnimatedContainer(
      ...
      width: context.screenWidth, // Адаптивная ширина
