...
class YandexMetrikaIntegrationTile extends ConsumerWidget {
  const YandexMetrikaIntegrationTile({
    super.key,
  ...
  void _openSettingsDrawer(BuildContext context, WidgetRef ref) {
    ref.read(integrationDrawerProvider.notifier).state =
        IntegrationDrawerType.yandexMetrika;
                    ...
                    children: [
                      ...
                      if (!isAvailable)
                        ...
                        SizedBox(
                          width: 150,
                          child: Text(
                            'Собирайте аналитику в Яндекс Метрике',
                            style: TextStyle(
