...
class MetaPixelIntegrationTile extends ConsumerWidget {
  const MetaPixelIntegrationTile({
    super.key,
  ...
  void _openSettingsDrawer(BuildContext context, WidgetRef ref) {
    ref.read(integrationDrawerProvider.notifier).state =
        IntegrationDrawerType.metaPixel;
                    ...
                    children: [
                      ...
                      if (!isAvailable)
                        ...
                        SizedBox(
                          width: 150,
                          child: Text(
                            'Отслеживайте события через Meta Pixel',
                            style: TextStyle(
